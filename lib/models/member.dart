class Member {
  ...
  factory Member.fromJson(Map<String, dynamic> json) {
    ...
    return Member(
      ...
      memberCode: memberData['member_code'] ?? memberData['card_number'], // Handle both keys
      points: memberData['points'] ?? 0,
      discount: (memberData['discount_percent'] as num? ?? memberData['discount'] as num? ?? 0.0).toDouble(), // Added discount
